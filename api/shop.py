...
# ==================================================================
SHOP_ITEMS = [
    {"tag": "[소모품]", "name": "카페인 앰플 / 야식 세트", "price": "1~5 AP", "desc": "생존을 위한 최소한의 연료"},
    {"tag": "[선물]",   "name": "수제 장식 / 기호품",      "price": "5~15 AP", "desc": "관계 개선용 뇌물 (효과 보장)"},
    {"tag": "[학업]",   "name": "기출 족보 / 논문 요약",   "price": "10~20 AP", "desc": "교수 취향 분석 완료 (A학점 패키지)"},
    {"tag": "[특수]",   "name": "위조 사유서 / 진단서",    "price": "20~30 AP", "desc": "완벽한 알리바이 제공"},
]
